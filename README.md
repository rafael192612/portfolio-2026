...
Como os scripts utilizam módulos ES, execute o projeto através de um servidor HTTP local.

Uma opção simples no **Visual Studio Code** é utilizar a extensão **Live Server**.
...
A marca principal está localizada em:
